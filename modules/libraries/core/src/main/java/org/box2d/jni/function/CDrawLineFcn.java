...
/**
 * It represents the read-only function {@code DrawLineFcn} (its
 ...
 * @since 1.0.0
 */
public interface CDrawLineFcn extends Pointer {
     ...
     * @param context long
     */
    void invoke(b2Vec2 p1, b2Vec2 p2, int color, long context);
