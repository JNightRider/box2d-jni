...
|-------------------|-----------------------------|----------|---------------------------|
| AArch32(ARM32)    | Linux/Android (arm64_v8a)   | Clang    | `:android(@aar)[Dp/Sp]`   |
| AArch64(ARM64)    | Linux/Android (armeabi_v7a) | Clang    | `:android(@aar)[Dp/Sp]`   |
| RISC-V64(riscv64) | Linux/Android (riscv64)     | Clang    | `:android(@aar)[Dp/Sp]`   |
| X86               | Linux/Android (x86)         | Clang    | `:android(@aar)[Dp/Sp]`   |
| X86-64            | Linux/Android (x86_64)      | Clang    | `:android(@aar)[Dp/Sp]`   |
